...
static CPValue meetValue(CPValue v1, CPValue v2) {
     ...
     */
    // TODO();
    if(v1.kind == CONST && v2.kind == CONST){  //此处应为控制流
    ...
    if(v1.kind == UNDEF && v2.kind == CONST) return get_CONST(v2.const_val);
    if(v1.kind == CONST && v2.kind == UNDEF) return get_CONST(v1.const_val);
    if(v1.kind == NAC && v2.kind == CONST) return get_NAC();
    if(v1.kind == CONST && v2.kind == NAC) return get_NAC();
    if(v1.kind == NAC && v2.kind == UNDEF) return get_NAC();
    if(v1.kind == UNDEF && v2.kind == NAC) return get_NAC();
...
static CPValue calculateValue(IR_OP_TYPE IR_op_type, CPValue v1, CPValue v2) {
    if(v1.kind == CONST && v2.kind == CONST) {
      ...
      if(v1.kind == UNDEF && v2.kind == UNDEF) return get_UNDEF();
      if(v1.kind == NAC && v2.kind == NAC) return get_NAC();
      if(v1.kind == UNDEF && v2.kind == CONST) return get_UNDEF();
      if(v1.kind == CONST && v2.kind == UNDEF) return get_UNDEF();
      if(v1.kind == NAC && v2.kind == CONST) return get_NAC();
      if(v1.kind == CONST && v2.kind == NAC) return get_NAC();
      if(v1.kind == NAC && v2.kind == UNDEF) return get_NAC();
      if(v1.kind == UNDEF && v2.kind == NAC) return get_NAC();
